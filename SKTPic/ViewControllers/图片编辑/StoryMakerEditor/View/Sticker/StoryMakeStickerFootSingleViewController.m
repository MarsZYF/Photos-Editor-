...
{
    if (!_dataArray) {
        _dataArray = [NSArray arrayWithObjects:[UIImage imageNamed:@"story_maker_tiezhi0"],[UIImage imageNamed:@"story_maker_tiezhi1"],[UIImage imageNamed:@"story_maker_tiezhi2"],[UIImage imageNamed:@"story_maker_tiezhi3"],[UIImage imageNamed:@"story_maker_tiezhi4"], [UIImage imageNamed:@"story_maker_tiezhi5"],[UIImage imageNamed:@"story_maker_tiezhi6"],[UIImage imageNamed:@"story_maker_tiezhi7"],[UIImage imageNamed:@"story_maker_tiezhi8"],[UIImage imageNamed:@"story_maker_tiezhi9"],[UIImage imageNamed:@"story_maker_tiezhi10"],[UIImage imageNamed:@"story_maker_tiezhi11"],[UIImage imageNamed:@"story_maker_tiezhi12"],[UIImage imageNamed:@"story_maker_tiezhi13"],[UIImage imageNamed:@"story_maker_tiezhi14"],[UIImage imageNamed:@"story_maker_tiezhi15"],[UIImage imageNamed:@"story_maker_tiezhi16"],[UIImage imageNamed:@"story_maker_tiezhi17"],[UIImage imageNamed:@"story_maker_tiezhi18"],[UIImage imageNamed:@"story_maker_tiezhi19"],[UIImage imageNamed:@"story_maker_tiezhi20"],[UIImage imageNamed:@"story_maker_tiezhi21"],nil];
    }
    return _dataArray;
}
