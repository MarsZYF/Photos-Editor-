...
{
    self.filterNameArray = [NSArray arrayWithObjects:
                            D_LocalizedCardString(@"filter_Nor"),
                            D_LocalizedCardString(@"filter_LOMO"),
                            D_LocalizedCardString(@"filter_B&W"),
                            D_LocalizedCardString(@"filter_gothic"),
                            D_LocalizedCardString(@"filter_retro"),
                            D_LocalizedCardString(@"filter_sharpen"),
                            D_LocalizedCardString(@"filter_elegance"),
                            D_LocalizedCardString(@"filter_WineRed"),
                            D_LocalizedCardString(@"filter_lemon"),
                            D_LocalizedCardString(@"filter_romance"),
                            D_LocalizedCardString(@"filter_halo"),
                            D_LocalizedCardString(@"filter_blues"),
                            D_LocalizedCardString(@"filter_dreamy"),
                            D_LocalizedCardString(@"filter_night"),
                            nil];
